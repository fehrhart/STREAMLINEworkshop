...
project="R-ODAFtutorial_Chr1" # $1 # Call script using project name as the only argument
# Specify the directory for the output
OUTPUT_DIR="/home/streamline/Downloads/${project}/output/"
# Specify location of input fastq files. ALL FILES IN THE FOLDER WILL BE PROCESSED 
RAW_SAMPLE_DIR="/home/streamline/Downloads/${project}/ShortTrainingData/"
# Specify extention of input files (".fastq" or ".fastq.gz") 
SUFFIX_INPUTFILES='.fastq'
...
ORGANISM_GENOME_ID="Human_GRCh38_r110"
...
GENOME_FILES_DIR="/home/streamline/Downloads/${project}/RefHuman_GRCh38_r110_Chr1/"
...
GENOME_FILE_NAME="/Homo_sapiens.GRCh38.dna.chromosome.1.fa"
...
GTF_FILE_NAME="Homo_sapiens.GRCh38.110.gtf"
